...
wasting other peoples time. Each standup had a max allowed length of 15 minutes. 
...
worked during the sprint. If there are any deviations from the plan, these are described and the reason 
for the deviation is explained.

\subsection{Explanation of Sprint Backlog}
...
"Funksjonstall" is an hour-independent number telling how difficult the team expects the task to be. The 
base number is how many hours the team expects to work to finish one story point. The base number multiplied 
with the function number for a task gives the estimated work hours needed to finish a task.

The base number may change from sprint to sprint, but not during a sprint. The team will do a evaluation of 
...
Based on how many team members are available and how many work hours they may put in, the team gives and 
'expected decrease of the story points left. This is reflected in the sprint burndown chart for each sprint, 
as a straight decreasing line. The amount of effort left is shown as a not-so-straight line in the burndown Â
chart. 